...
const categories = [
  ...
  { id: 'extinction',  label: 'Extinction auto.' },
...
const products = [
  ...
  /* ── EXTINCTION AUTOMATIQUE ───────────────────────── */
  {
    ...
    cat: 'extinction',
    name: 'KARA 8 EXCT',
    badge: 'Extinction auto.',
    badgeColor: '#1e8bc3',
    desc: 'Centrale d\'extinction automatique à gaz avec ECS intégré — 8 boucles conventionnelles, gestion complète des asservissements.',
    img: `${BASE}products/cat_centrales_a.webp`,
    specs: ['8 boucles conventionnelles', 'ECS intégré', 'Gaz & eau', 'EN 12094'],
    applications: ['Salles informatiques', 'Archives & musées', 'Locaux électriques', 'Caves & parkings'],
    certifications: ['EN 12094', 'NF SSI', 'Marquage CE', 'APSAD R13'],
    details: 'La centrale KARA 8 EXCT est dédiée à la protection des locaux par extinction automatique à gaz. Elle intègre un ECS conventionnel 8 boucles et gère l\'ensemble des séquences d\'extinction : temporisation, diffusion d\'alarme, commande d\'actionneur, vérification de position. Compatible avec les agents extincteurs CO2, FM200, Novec.',
    finsecurUrl: 'https://www.finsecur.com/produits/extinction',
  },
  {
    id: 'corail',
    cat: 'extinction',
    name: 'CORAIL',
    badge: 'Module extinction',
    badgeColor: '#1e8bc3',
    desc: 'Module de commande et de signalisation pour systèmes d\'extinction automatique — pilotage des asservissements et contrôle de position.',
    img: `${BASE}products/cat_centrales_b.webp`,
    specs: ['Module compact', 'Commande asservissements', 'Contrôle de position', 'Boucle adressable'],
    applications: ['En extension d\'une centrale SSI', 'Locaux isolés', 'Data centers', 'Chambres froides'],
    certifications: ['EN 12094', 'NF SSI', 'Marquage CE'],
    details: 'Le CORAIL est un module esclave conçu pour piloter les systèmes d\'extinction automatique en association avec une centrale SSI Finsecur. Il assure la temporisation, la diffusion d\'alarme sonore et lumineuse, le déclenchement de l\'extincteur et la vérification du bon fonctionnement des asservissements.',
    finsecurUrl: 'https://www.finsecur.com/produits/extinction',
  },
  {
    id: 'caraibes',
    cat: 'extinction',
    name: 'CARAÏBES',
    badge: 'Extinction adressable',
    badgeColor: '#1e8bc3',
    desc: 'Centrale d\'extinction automatique adressable multizone — pour la protection simultanée de plusieurs locaux indépendants.',
    img: `${BASE}products/cat_centrales_sonora.webp`,
    specs: ['Adressable multizone', 'Jusqu\'à 4 zones indép.', 'Boucle auto-codante', 'EN 12094'],
    applications: ['Complexes industriels', 'Bâtiments multi-locaux', 'Tableaux électriques HTA', 'Sites sensibles'],
    certifications: ['EN 12094', 'NF SSI', 'APSAD R13', 'Marquage CE'],
    details: 'La centrale CARAÏBES permet la gestion indépendante de plusieurs zones d\'extinction dans un seul équipement. Chaque zone dispose de sa propre temporisation, de ses propres asservissements et de son indicateur de statut. La technologie adressable garantit une localisation précise des défauts et des événements.',
    finsecurUrl: 'https://www.finsecur.com/produits/extinction',
  },
  ...
  /* ── SUPERVISION ───────────────────────────────────── */
  {
    ...
    cat: 'supervision',
    name: 'ScanServer',
    badge: 'Supervision multi-sites',
    badgeColor: '#8e44ad',
    desc: 'Logiciel de supervision SSI multi-sites avec plans d\'étage interactifs, gestion des alarmes en temps réel et rapports automatiques.',
    img: `${BASE}products/mistral_200.webp`,
    specs: ['Multi-sites illimités', 'Plans d\'étage interactifs', 'Historique complet', 'Compatible toute la gamme Finsecur'],
    applications: ['Hôpitaux multi-bâtiments', 'Campus universitaires', 'Centres commerciaux', 'Hôtels & résidences'],
    certifications: ['Compatible EN 54', 'NF SSI', 'Interface PC standard'],
    details: 'ScanServer est la solution de supervision centralisée des installations SSI Finsecur. Il permet à un opérateur de visualiser en temps réel l\'état de toutes les centrales d\'un site ou d\'un parc de bâtiments depuis un poste PC unique. Affichage sur plans d\'étage, gestion des alarmes, traçabilité réglementaire et rapports automatiques.',
    finsecurUrl: 'https://www.finsecur.com/produits/supervision',
    featured: true,
  },
  {
    id: 'scanserver-mini',
    cat: 'supervision',
    name: 'ScanServer Mini',
    badge: 'Supervision compacte',
    badgeColor: '#8e44ad',
    desc: 'Version compacte du ScanServer pour sites de taille moyenne — toutes les fonctions essentielles dans un format optimisé.',
    img: `${BASE}products/boreal_lr.webp`,
    specs: ['Sites de taille moyenne', 'Interface simplifiée', 'Rapports automatiques', 'Installation rapide'],
    applications: ['ERP mono-site', 'Établissements scolaires', 'Maisons de retraite', 'Cliniques privées'],
    certifications: ['Compatible EN 54', 'NF SSI'],
    details: 'ScanServer Mini est la déclinaison économique et simplifiée du ScanServer. Il offre les fonctions essentielles de supervision pour un seul site ou un nombre limité de bâtiments. Idéal pour les budgets maîtrisés tout en conservant la traçabilité réglementaire et la visualisation des alarmes sur plans.',
    finsecurUrl: 'https://www.finsecur.com/produits/supervision',
  },
  {
    id: 'scanserver-hist',
    cat: 'supervision',
    name: 'ScanServer Historique',
    badge: 'Archivage & traçabilité',
    badgeColor: '#8e44ad',
    desc: 'Module d\'archivage et d\'analyse des événements SSI — traçabilité réglementaire, audit des interventions et rapports de conformité.',
    img: `${BASE}products/egee_lcd.webp`,
    specs: ['Archivage illimité', 'Rapports PDF automatiques', 'Audit des interventions', 'Export Excel/CSV'],
    applications: ['Obligations réglementaires', 'Commissions de sécurité', 'Audit incendie', 'Maintenance préventive'],
    certifications: ['NF SSI', 'Conformité réglementaire'],
    details: 'ScanServer Historique enregistre et archive l\'ensemble des événements de vos installations SSI : alarmes, défauts, tests, interventions. Il génère automatiquement les rapports exigés par les commissions de sécurité et facilite la préparation des visites de contrôle. Recherche multicritères et export des données.',
    finsecurUrl: 'https://www.finsecur.com/produits/supervision',
  },
  {
    id: 'interfaces-reseau',
    cat: 'supervision',
    name: 'Interfaces Réseau',
    badge: 'Connectivité IP',
    badgeColor: '#8e44ad',
    desc: 'Modules de connexion IP et TCP/IP pour l\'intégration des centrales Finsecur dans les réseaux de supervision existants (BACnet, Modbus).',
    img: `${BASE}products/sextant_doa.webp`,
    specs: ['TCP/IP & BACnet', 'Modbus RTU/TCP', 'Intégration GTB/GTC', 'Configuration web'],
    applications: ['Bâtiments intelligents', 'Intégration GTB', 'Réseaux d\'entreprise', 'Supervision distante'],
    certifications: ['EN 54', 'BACnet B-ASC', 'Marquage CE'],
    details: 'Les interfaces réseau Finsecur permettent d\'intégrer les centrales SSI dans les systèmes de gestion technique de bâtiment (GTB/GTC). Elles prennent en charge les protocoles BACnet/IP, Modbus TCP et Modbus RTU, permettant la remontée des alarmes et des états vers les superviseurs tiers.',
    finsecurUrl: 'https://www.finsecur.com/produits/supervision',
  },
  ...
  /* ── ACCESSOIRES ───────────────────────────────────── */
  {
    ...
    cat: 'accessoires',
    name: 'AVISO',
    badge: 'Sirène intérieure',
    badgeColor: '#e8621a',
    desc: 'Sirène de signalisation incendie pour usage intérieur — signalisation sonore puissante conforme NF S 32-001.',
    img: `${BASE}products/sextant_dmc.webp`,
    specs: ['Usage intérieur', 'Puissance 100 dB(A)', 'Alimentation 24V', 'EN 54-3'],
    applications: ['Couloirs d\'évacuation', 'Bureaux', 'Commerces', 'ERP toutes catégories'],
    certifications: ['EN 54-3', 'NF SSI', 'Marquage CE', 'NF S 32-001'],
    details: 'La sirène AVISO est le diffuseur sonore d\'évacuation de référence pour les systèmes SSI Finsecur. Sa conception robuste et son niveau sonore de 100 dB(A) garantissent une audibilité parfaite dans tous les types de locaux. Alimentation 24V DC compatible avec toutes les centrales Finsecur.',
    finsecurUrl: 'https://www.finsecur.com/produits/accessoires',
  },
  {
    id: 'aviso-ext',
    cat: 'accessoires',
    name: 'AVISO EXT',
    badge: 'Sirène extérieure',
    badgeColor: '#e8621a',
    desc: 'Sirène extérieure anti-vandalisme IP55 — signalisation incendie pour façades, parkings et accès extérieurs.',
    img: `${BASE}products/sextant_dma.webp`,
    specs: ['IP55 anti-vandalisme', 'Usage extérieur', '105 dB(A)', 'Boîtier ABS renforcé'],
    applications: ['Façades de bâtiments', 'Parkings extérieurs', 'Issues de secours', 'Zones industrielles'],
    certifications: ['EN 54-3', 'IP55', 'NF SSI', 'Marquage CE'],
    details: 'L\'AVISO EXT est la version extérieure de la gamme AVISO. Son boîtier ABS renforcé et son indice de protection IP55 lui permettent de résister aux intempéries et aux actes de vandalisme. Idéal pour signaler l\'alarme incendie sur les façades et dans les zones non couvertes par les diffuseurs intérieurs.',
    finsecurUrl: 'https://www.finsecur.com/produits/accessoires',
  },
  {
    id: 'fi-rep',
    cat: 'accessoires',
    name: 'FI-REP',
    badge: 'Répétiteur d\'info',
    badgeColor: '#7f8c8d',
    desc: 'Répétiteur d\'information incendie pour report d\'alarme en position de veille — affichage déporté de l\'état de la centrale.',
    img: `${BASE}products/sextant_bcm.webp`,
    specs: ['Report déporté', 'Affichage état centrale', 'Alimentation 24V', 'RS485'],
    applications: ['Accueil & gardiennage', 'Loge du gardien', 'PC sécurité', 'Poste central de sécurité'],
    certifications: ['NF SSI', 'EN 54', 'Marquage CE'],
    details: 'Le FI-REP permet le report déporté des informations de la centrale SSI vers un poste de surveillance ou d\'accueil. Il affiche l\'état du système (veille, alarme, défaut) et les zones concernées, permettant au personnel d\'accueil d\'agir rapidement même sans accès direct à la centrale.',
    finsecurUrl: 'https://www.finsecur.com/produits/accessoires',
  },
  {
    id: 'indicateur-action',
    cat: 'accessoires',
    name: 'Indicateur d\'Action',
    badge: 'Indicateur lumineux',
    badgeColor: '#e67e22',
    desc: 'Indicateur visuel de détection — signale l\'activation du détecteur de fumée associé, pose encastrée ou saillie.',
    img: `${BASE}products/cap_112a.webp`,
    specs: ['LED rouge clignotante', 'Pose encastrée ou saillie', 'Câblage parallèle', 'EN 54'],
    applications: ['Faux plafonds', 'Gaines techniques', 'Zones difficiles d\'accès', 'Couloirs & coursives'],
    certifications: ['EN 54', 'NF SSI', 'Marquage CE'],
    details: 'L\'indicateur d\'action est un accessoire indispensable pour signaler l\'activation d\'un détecteur de fumée installé en faux plafond ou dans une zone difficile d\'accès. Sa LED rouge clignotante visible depuis le couloir permet d\'identifier rapidement la zone en alarme sans ouvrir les faux plafonds.',
    finsecurUrl: 'https://www.finsecur.com/produits/accessoires',
  },
  {
    id: 'alimentation-secourue',
    cat: 'accessoires',
    name: 'Alimentation Secourue',
    badge: 'Alimentation SSI',
    badgeColor: '#27ae60',
    desc: 'Bloc d\'alimentation de secours certifié SSI — garantit le fonctionnement de l\'installation en cas de coupure secteur.',
    img: `${BASE}products/cap_200.webp`,
    specs: ['1 A / 3 A / 6 A', 'Gestion batterie intégrée', 'Supervision état', 'EN 54-4'],
    applications: ['Extension de centrale', 'Alimentation déportée', 'Renfort de puissance', 'Sites isolés'],
    certifications: ['EN 54-4', 'NF SSI', 'Marquage CE'],
    details: 'Les alimentations secourues Finsecur garantissent la continuité de service des installations SSI même lors d\'une coupure secteur. Elles intègrent un chargeur automatique pour batteries étanches, un superviseur d\'état et une signalisation de défaut. Disponibles en plusieurs puissances de 1 A à 6 A.',
    finsecurUrl: 'https://www.finsecur.com/produits/accessoires',
  },
  {
    id: 'sextant-dvaf',
    cat: 'accessoires',
    name: 'SEXTANT DVAF',
    badge: 'Diffuseur vocal',
    badgeColor: '#e8621a',
    desc: 'Diffuseur vocal autonome d\'alarme feu — annonces vocales préenregistrées pour l\'évacuation des personnes.',
    img: `${BASE}products/sextant_dma.webp`,
    specs: ['Message vocal préenregistré', 'Puissance 6 W', 'Adressable', 'EN 54-24'],
    applications: ['ERP grande capacité', 'Centres commerciaux', 'Aéroports & gares', 'Hôtels & hôpitaux'],
    certifications: ['EN 54-24', 'NF S 32-001', 'NF SSI', 'Marquage CE'],
    details: 'Le SEXTANT DVAF est un diffuseur sonore vocal adressable destiné aux systèmes d\'alarme vocale pour l\'évacuation. Il diffuse des messages préenregistrés guidant les occupants vers les sorties de secours. Sa technologie adressable permet la diffusion sélective par zone, optimisant l\'évacuation des grandes surfaces.',
    finsecurUrl: 'https://www.finsecur.com/produits/accessoires',
  },
